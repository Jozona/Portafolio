...
var language = {
  eng: {
    ...
    hSobreMi: "About me",
    txtDescripcion:
      "Hello, my name is Josué Emiliano Espinoza Gutiérrez. I'm a software developer and graduate of the Faculty of Physical-Mathematical Sciences at the UANL. Currently, I work as a software developer and web designer. I am certified by the TOEFL iBT with an advanced level of english (C1). A pleasure to meet you.",
    hContactar: "Contact me",
    hProyectos: "Projects",
    web: "https://gh-card.dev/repos/Jozona/Tu-blog.png",
    mad: "./src/imagenes/Untitled.png",
    intermedia:
      "https://gh-card.dev/repos/Jozona/Tienda-En-Linea-Web.png?fullname=",
...
if (window.location.hash) {
  if (window.location.hash === "#en") {
    ...
    hHabilidadesTxt.textContent = language.eng.habilidades;
